...
// Custom Bulletproof Dropdown Component (Eliminates Browser Native Arrow Defects)
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white dark:bg-slate-900 w-full max-w-5xl rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[92vh]">
        ...
        {/* Filter Controls Bar - Custom Bulletproof Dropdowns */}
              ...
              {filteredData.length === 0 && (
                <tr>
                  <td colSpan={7} className="p-8 text-center text-slate-400 font-bold">
                    Tidak ada data pasien proses pulang yang sesuai dengan filter.
                  </td>
                </tr>
              )}
            </tbody>
