        ...
        {gridRows.map((s) => (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              {s.isBooked ? (
                <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-[#007399]/15 text-[#007399] dark:text-cyan-300 border border-[#007399]/30">
            ...
            {s.isBooked ? (
              <div className="my-2">
                ...
                <div className="text-xs text-[#007399] dark:text-cyan-400 font-extrabold mt-0.5 uppercase">{s.data.channel || 'PRIMAYAAPP'}</div>
              </div>
            ) : (
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-slate-800 flex justify-end">
              {s.isBooked ? (
                <button className="px-3 py-1 bg-[#007399] hover:bg-[#005e7e] text-white text-xs font-extrabold rounded-full shadow-sm cursor-pointer active:scale-95 flex items-center gap-1">
                  <span className="material-symbols-outlined text-xs">edit</span> Edit Slot
                </button>
              ) : (
                <button 
                  onClick={() => onSelectSlot(s.time)}
                  className="px-3 py-1 bg-amber-500 hover:bg-amber-600 text-white text-xs font-extrabold rounded-full shadow-sm cursor-pointer active:scale-95 flex items-center gap-1"
                >
