      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3.5">
        <div className="p-4 rounded-3xl bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 flex items-center justify-between shadow-xs">
          <div>
            ...
            <div className="text-2xl font-black text-slate-900 dark:text-white mt-1">4 <span className="text-xs font-normal">Order</span></div>
        ...
        <div className="p-4 rounded-3xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 flex items-center justify-between shadow-xs">
          <div>
            ...
            <div className="text-2xl font-black text-amber-600 dark:text-amber-400 mt-1">5 <span className="text-xs font-normal">Tabung</span></div>
            <div className="text-[10px] text-slate-500 mt-0.5">Auto-Analyzer Sedang Berjalan</div>
          </div>
        ...
        <div className="p-4 rounded-3xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800 flex items-center justify-between shadow-xs">
          <div>
            ...
            <div className="text-2xl font-black text-rose-600 dark:text-rose-400 mt-1">2 <span className="text-xs font-normal">Belum Konfirmasi</span></div>
            <div className="text-[10px] text-rose-500 font-bold mt-0.5">JCI IPSG 2 Wajib Read-Back</div>
          </div>
        ...
        <div className="p-4 rounded-3xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 flex items-center justify-between shadow-xs">
          <div>
            ...
            <div className="text-2xl font-black text-emerald-600 dark:text-emerald-400 mt-1">18 <span className="text-xs font-normal">Hasil Rilis</span></div>
