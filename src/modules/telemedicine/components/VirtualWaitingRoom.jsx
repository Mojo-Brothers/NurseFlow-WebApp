    ...
    <div className="h-full bg-surface-container flex items-center justify-center p-8 animate-fade-in">
       <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex-column gap-8">
             ...
             <div className="flex-row gap-4 min-w-0">
                <div className="flex-column gap-1 bg-surface p-6 rounded-[2rem] shadow-sm flex-1 min-w-0">
             ...
             <div className="p-8 bg-primary/10 rounded-[3rem] border border-primary/20 flex-row gap-6 items-center min-w-0">
                <div className="w-16 h-16 bg-surface rounded-2xl flex-row items-center justify-center shadow-lg shrink-0">
          ...
          <ClinicalCard padding="0" className="aspect-[4/5] bg-surface shadow-2xl relative overflow-hidden group">
