  ...
  return (
    <>
      <div className="w-full bg-slate-900 border-b border-slate-800 text-white px-4 py-2 flex flex-wrap items-center justify-between gap-3 text-xs shadow-md">
        ...
        {/* Right: Emergency Code Triggers & Notification Bell */}
        <div className="flex items-center gap-2">
          {/* Notification Trigger Bell */}
          <button
            onClick={togglePanel}
            className="relative p-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 flex items-center justify-center cursor-pointer transition-transform active:scale-95"
