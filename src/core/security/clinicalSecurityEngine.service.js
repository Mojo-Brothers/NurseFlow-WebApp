...
export const PERMISSION_MATRIX = Object.freeze({
  ...
  [CLINICAL_ROLES.ADMISSION_STAFF]: {
    [CLINICAL_RESOURCES.PATIENT]: [CLINICAL_ACTIONS.READ, CLINICAL_ACTIONS.WRITE, CLINICAL_ACTIONS.UPDATE],
    [CLINICAL_RESOURCES.ENCOUNTER]: [CLINICAL_ACTIONS.READ, CLINICAL_ACTIONS.WRITE, CLINICAL_ACTIONS.UPDATE],
    [CLINICAL_RESOURCES.BILLING_RECORD]: [CLINICAL_ACTIONS.READ]
  },
  [CLINICAL_ROLES.BILLING_STAFF]: {
    [CLINICAL_RESOURCES.PATIENT]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.ENCOUNTER]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.BILLING_RECORD]: [CLINICAL_ACTIONS.READ, CLINICAL_ACTIONS.WRITE, CLINICAL_ACTIONS.UPDATE]
  },
  [CLINICAL_ROLES.LAB_TECH]: {
    [CLINICAL_RESOURCES.PATIENT]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.ENCOUNTER]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.LAB_ORDER]: [CLINICAL_ACTIONS.READ, CLINICAL_ACTIONS.UPDATE]
  },
  [CLINICAL_ROLES.RADIOLOGIST]: {
    [CLINICAL_RESOURCES.PATIENT]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.ENCOUNTER]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.RADIOLOGY_ORDER]: [CLINICAL_ACTIONS.READ, CLINICAL_ACTIONS.UPDATE]
  },
  [CLINICAL_ROLES.ADMINISTRATOR]: {
    [CLINICAL_RESOURCES.PATIENT]: [CLINICAL_ACTIONS.READ, CLINICAL_ACTIONS.WRITE, CLINICAL_ACTIONS.UPDATE],
    [CLINICAL_RESOURCES.ENCOUNTER]: [CLINICAL_ACTIONS.READ, CLINICAL_ACTIONS.WRITE, CLINICAL_ACTIONS.UPDATE],
    [CLINICAL_RESOURCES.SOAP_NOTE]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.CPPT_NOTE]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.CPOE_PRESCRIPTION]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.EMAR_ADMINISTRATION]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.LAB_ORDER]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.RADIOLOGY_ORDER]: [CLINICAL_ACTIONS.READ],
    [CLINICAL_RESOURCES.BILLING_RECORD]: [CLINICAL_ACTIONS.READ, CLINICAL_ACTIONS.WRITE, CLINICAL_ACTIONS.AUDIT]
  }
});
