    ...
    mockClient = {
      query: vi.fn(async (sql, params = []) => {
        ...
        if (normalized.startsWith('INSERT INTO MEDICATION_ORDERS')) {
          const hasTenant = params.length >= 40;
          const shift = hasTenant ? 1 : 0;
          const newMed = {
            id: params[0],
            tenant_id: hasTenant ? params[1] : undefined,
            order_id: params[1 + shift],
            medication_code: params[2 + shift],
            medication_name: params[3 + shift],
            dosage: params[4 + shift],
            route: params[5 + shift],
            frequency: params[6 + shift],
            duration: params[7 + shift],
            quantity: params[8 + shift],
            unit_price: params[9 + shift],
            total_price: params[10 + shift],
            is_cito: params[11 + shift],
            high_alert: params[12 + shift],
            lasa_flag: params[13 + shift],
            is_antibiotic: params[14 + shift],
            review_status: params[15 + shift],
            status: params[16 + shift],
            cpoe_order_id: params[17 + shift],
            cpoe_item_id: params[18 + shift],
            encounter_id: params[19 + shift],
            patient_id: params[20 + shift],
            dosage_quantity: params[21 + shift],
            dosage_unit: params[22 + shift],
            scheduled_times: params[23 + shift],
            is_prn: params[24 + shift],
            prn_indication: params[25 + shift],
            cdss_screened: params[26 + shift],
            cdss_override_reason: params[27 + shift],
            cdss_overridden_by: params[28 + shift],
            pharmacist_review_status: params[29 + shift],
            dispense_status: params[30 + shift],
            version: params[31 + shift],
            concentration_mg_ml: params[32 + shift],
            infusion_rate_ml_hr: params[33 + shift],
            infusion_volume_ml: params[34 + shift],
            timing_type: params[35 + shift],
            clinical_indication_notes: params[36 + shift],
            created_at: params[37 + shift],
            updated_at: params[38 + shift]
          };
          if (activeTransactionState) {
